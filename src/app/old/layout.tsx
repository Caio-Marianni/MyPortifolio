...
export const metadata = {
  title: "Caio Marianni - Versão Antiga",
  description: "Versão arquivada do portfólio pessoal. Explore meus projetos, certificações e experiência profissional.",
  ...
  openGraph: {
    title: "Caio Marianni - Versão Antiga",
    description: "Versão arquivada do portfólio pessoal.",
    url: "https://caio-marianni-portfolio.vercel.app/old",
...
export default async function OldLayout({ children }: { children: ReactNode }) {
  return (
