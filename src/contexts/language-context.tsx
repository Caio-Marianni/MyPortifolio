...
const translations: Record<Language, Record<string, string>> = {
  pt: {
    ...
    "contact.description": "Vamos trabalhar juntos! Entre em contato comigo através do formulário ou pelas redes sociais.",
    "contact.back": "Voltar",
    "contact.info": "Informações de contato",
    "contact.social": "Redes sociais",
    "contact.availability": "Disponibilidade",
    "contact.availabilityText": "Aberto a novos projetos e oportunidades de trabalho freelance. Respondo normalmente em até 24 horas.",
    "contact.name": "Nome",
    "contact.namePlaceholder": "Seu nome",
    "contact.email": "Email",
    "contact.emailPlaceholder": "seu@email.com",
    "contact.subject": "Assunto",
    "contact.subjectPlaceholder": "Sobre o que quer falar?",
  ...
  en: {
    ...
    "contact.description": "Let's work together! Get in touch with me through the form or social media.",
    "contact.back": "Back",
    "contact.info": "Contact information",
    "contact.social": "Social media",
    "contact.availability": "Availability",
    "contact.availabilityText": "Open to new projects and freelance opportunities. I usually respond within 24 hours.",
    "contact.name": "Name",
