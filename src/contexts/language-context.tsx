...
const translations: Record<Language, Record<string, string>> = {
  pt: {
    ...
    "lobby.sub": "Thumbnails que seguram o clique e aplicações web que aguentam o que vem depois.",
    ...
    "projects.mode.layman": "Leigo",
    "projects.mode.dev": "Dev",
    ...
    "contact.write": "Escreva",
    "contact.formHint": "Cai direto no meu e-mail.",
  ...
  en: {
    ...
    "status.thumbnails": "Thumbnails",
    "lobby.sub": "Thumbnails that earn the click and web apps that handle what comes after.",
    ...
    "contact.write": "Write",
    "contact.formHint": "Goes straight to my inbox.",
    "thumbnails.title": "Thumbnails",
