    ...
    <div class="container mx-auto px-4">
      <div class="grid grid-cols-4 grid-rows-2 lg:grid-rows-2 gap-4">
        ...
        <div className="col-span-4 lg:col-span-2">
          <h2 class="text-xl font-bold mb-4">{{ $t("AboutTitle") }}</h2>
        ...
        <div className="col-span-2 lg:col-span-1">
          <h2 class="text-xl font-bold mb-4">{{ $t("CertificationsTitle") }}</h2>
        ...
        <div className="col-span-1">
          <h2 class="text-xl font-bold mb-4">{{ $t("ContactTitle") }}</h2>
          <div class="flex gap-2 mt-4 flex-row">
            <a
              class="border rounded-full p-2 bg-neutral-800 border-gray-500 hover:-translate-y-2 hover:border-white hover:bg-neutral-600 transition-all duration-500 ease-in-out"
