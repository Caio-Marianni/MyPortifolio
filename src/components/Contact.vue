...
import { certifications } from '@/core/constants';
    ...
    <div class="container mx-auto px-4">
      <div class="grid grid-cols-4 grid-rows-2 lg:grid-rows-2 gap-4">
        ...
        <div className="col-span-2 lg:col-span-1">
          <h2 class="text-xl font-bold mb-4 text-text-50">{{ $t("CertificationsTitle") }}</h2>
          <ul class="flex flex-col gap-3 text-text-50 text-opacity-50">
            <li v-for="(certification, index) in certifications" :key="certification.id" :certification="certification" :certificationId="index" class="border-b border-gray-300 pb-2">
              <span class="font-semibold text-lg">{{ $t(`certification.${index}.name`) }}</span>
              <br />
              <span class="text-sm text-gray-400"> {{ $t(`certification.${index}.description`) }} • {{ $t(`certification.${index}.duration`) }} ({{ $t(`certification.${index}.date`) }}) </span>
            </li>
          </ul>
        </div>
        <!-- Contact Platforms Section -->
        <div className="col-span-1">
          <h2 class="text-xl font-bold mb-4 text-text-50">{{ $t("ContactTitle") }}</h2>
          <div class="flex gap-2 mt-4 flex-row">
            <a
              class="border rounded-full p-2 bg-background-900 border-primary-500 hover:-translate-y-2 hover:border-white hover:bg-background-900 transition-all duration-500 ease-in-out"
              href="https://wa.me/5562981160081"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20" viewBox="0 0 50 50" fill="#f66c09">
                <path
            ...
            <a
              ...
              rel="noopener noreferrer"
            >
              <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20" viewBox="0 0 30 30" fill="#f66c09">
                <path
            ...
            <a
              class="border rounded-full p-2 bg-background-900 border-primary-500 hover:-translate-y-2 hover:border-white hover:bg-background-900 transition-all duration-500 ease-in-out"
              href="https://www.linkedin.com/in/caio-marianni-de-morais/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20" viewBox="0 0 50 50" fill="#f66c09">
