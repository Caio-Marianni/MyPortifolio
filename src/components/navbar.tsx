      ...
      <div className="container flex h-14 px-4 md:px-10 items-center">
        <div className="mr-0 sm:mr-4 flex ">
          ...
          <nav className="hidden md:flex items-center space-x-6 text-sm font-medium">
            <Link className="transition-colors hover:text-foreground/80 text-foreground/60" rel="noopener noreferrer" aria-label="about" href="#about">
              {t("about")}
            </Link>
            <Link className="transition-colors hover:text-foreground/80 text-foreground/60" rel="noopener noreferrer" aria-label="portfolio" href="#projects">
              {t(portfolio)}
            </Link>
          </nav>
        </div>
