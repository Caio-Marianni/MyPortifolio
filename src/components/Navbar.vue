...
<template>
  <div class="md:container sticky top-0 md:top-4 flex justify-center items-center m-auto z-50">
    <div class="flex items-center justify-between w-full md:m-4 p-2 px-6 md:border border-b border-background-950 md:rounded-full bg-background-900 shadow-md">
      <!-- Left side (logo) -->
      <div>
      ...
      <div class="flex justify-center items-center">
        ...
        <LanguageToggle />
        <!-- Contact Button-->
        <a href="#contact" class="ml-5 overflow-hidden bg-accent-700 text-text-50 focus:ring-4 focus:ring-accent-300 inline-flex items-center px-6 py-2 rounded-full justify-center">
          <span>{{ $t("btnNav") }}</span>
        </a>
      </div>
    </div>
