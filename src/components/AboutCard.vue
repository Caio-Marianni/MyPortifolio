    ...
    <div class="max-w-md z-20">
      ...
      <div class="relative flex place-items-center mb-2">
        ...
        <div class="absolute right-4 flex items-center gap-3 sm:gap-0">
          ...
          <a href="" class="shadow-md w-10 h-10 -ml-6 bg-secondary-900 border-2 border-secondary-500 rounded-full flex items-center justify-center cursor-pointer hover:bg-secondary-900 hover:border-secondary-200 transition-all duration-500 ease-in-out ">
