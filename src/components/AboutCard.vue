    ...
    <div class="max-w-md z-20">
      ...
      <div class="relative flex place-items-center mb-2">
        ...
        <div class="absolute right-4 flex items-center gap-3 sm:gap-0">
          ...
          <a href="" class="shadow-md w-10 h-10 hover:mr-6 bg-secondary-900 border-2 border-secondary-500 rounded-full flex items-center justify-center cursor-pointer hover:bg-secondary-900 hover:border-secondary-200 transition-all duration-500 ease-in-out">
          ...
          <a href="" class="shadow-md w-10 h-10 -ml-5 hover:mr-7 hover:-ml-4 bg-secondary-900 border-2 border-secondary-500 rounded-full flex items-center justify-center cursor-pointer hover:bg-secondary-900 hover:border-secondary-200 transition-all duration-500 ease-in-out">
          ...
          <a href="#contact" class="shadow-md w-10 h-10 -ml-6 bg-secondary-900 border-2 border-secondary-500 rounded-full flex items-center justify-center cursor-pointer hover:bg-secondary-900 hover:border-secondary-200 transition-all duration-500 ease-in-out ">
      ...
      <p class="text-text-50 text-opacity-50 text-sm md:text-base pr-5">{{ $t('CardAboutSub') }}</p>     
    
      <!-- About me -->
      <a href="#contact">
        <button class="bg-accent-500 hover:bg-accent-800 text-text-50 py-2 px-3 rounded mt-3 transition-all">{{ $t('CardAboutBtn') }}</button>
      </a>
    </div>
  </div>
</template>   